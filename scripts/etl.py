...
# Re-ordering columns :
df = df.select("emp_id", "full_name", "gender", "dob", "join_date", "department", "job_title", "manager_id", "location", "status", "employment_type", "salary", "email", "phone", "last_working_day")
...
# Saving cleaned dataset as csv, json, and parquet format :
print(df.show())
...
pandas_df.to_csv(r'E:\Data Engineer ETL Project\cleaned_data\employee_data_cleaned.csv', index=False)
